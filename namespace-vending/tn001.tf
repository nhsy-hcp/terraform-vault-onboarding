module "tn001_namespace" {
  ...
  rbac_delegation = {
    ...
    "tn001-team2-reader" = {
      group_name = "vault-tn001-team2-viewer"
      policies = {
    ...
    "tn001-team1-contributor" = {
      group_name = "vault-tn001-team1-contributor"
      policies = {
    ...
    "vault-tn001-team1-admin" = {
      group_name = "vault-tn001-team1-admin"
      policies = {
        kv-shared    = data.vault_policy_document.shared_team_contributor["team1"].hcl,
        kv-dedicated = data.vault_policy_document.dedicated_team_contributor["team1"].hcl,
      }
